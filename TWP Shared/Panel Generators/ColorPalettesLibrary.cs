...
namespace TWP_Shared
{
    public static class ColorPalettesLibrary
    {
        ...
        public static readonly ColorPalette[] Palettes =
        {
            ...
            new ColorPalette(new Color(0,60,18), new Color(0,103,36), new Color(0,60,18),
            ...
            new ColorPalette(new Color(40,40,40), new Color(131,10,10), new Color(35,35,35),
                             new Color(249,106,0), new Color(249,106,0), new Color(247, 0, 0)),
            new ColorPalette(new Color(73,33,8), new Color(39,23,5), new Color(73,33,8),
            ...
            new ColorPalette(new Color(20,40,1), new Color(52,88,0), new Color(15,35,1),
                             new Color(179,88,127), new Color(179,88,127), new Color(98, 175, 164)),
            new ColorPalette(new Color(51,0,1), new Color(93,64,39), new Color(51,0,1),
            ...
            new ColorPalette(new Color(55,71,74), new Color(8,33,41), new Color(55,71,74),
